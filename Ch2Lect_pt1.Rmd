...
- Demo: SlopeSimulation.R [R code file](https://www.dropbox.com/s/7v8vzqxrc9lbiad/SlopeSimulation.R?dl=0)
...
Test statistic:
$$\frac{\hat\beta_i-c}{\mbox{SE}_{\hat\beta_i}}$$
...
$$\frac{\hat\beta_i}{\mbox{SE}_{\hat\beta_i}}$$
