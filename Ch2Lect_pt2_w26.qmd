...
### How is $r^2$ the proportion of variability explained?
...
-   Regression ANOVA asks: does $X$ explain meaningful variability in
    $Y$?
...
-   Three equivalent tests assess significance: slope $t$, ANOVA $F$,
    and correlation $t$.

-   Statistical significance ≠ practical significance $\Longrightarrow$
    consider effect size (e.g., <br> Cohen’s $f^2$).
